...
class Wheat:
    def __init__(self, x: int, y: int, height: int = 40,
    ...
    def draw(self, screen: pygame.Surface, dt: float) -> None:
        ...
        for i in range(self.segments):
            ...
            pygame.draw.line(screen, self.color, (prev_x, prev_y),
                             (next_x, next_y), self.stalk_width)
...
if __name__ == "__main__":
    ...
    wheat_stalks = [Wheat(400 + random.randint(-200, 200),
